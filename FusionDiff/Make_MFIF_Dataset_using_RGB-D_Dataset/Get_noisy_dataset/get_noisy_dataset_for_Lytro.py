# Function: Gaussian noise, Impulse noise, Poisson noise, Rayleigh noise, and uniform noise were added to the Lytro dataset
...
if __name__ == '__main__':
    ...
    assert len(source_1_names) == len(source_2_names)

    noisy_dataset_path = "Noisy_dataset/Lytro"
    ...
    for i in tqdm(range(len(source_1_names)), desc="process"):
        ...
        if number < 10:
            gauss_img_name = "0" + str(number) + "_gauss.jpg"
        else:
        ...
        if number < 10:
            impulse_img_name = "0" + str(number) + "_impulse.jpg"
        else:
        ...
        if number < 10:
            poisson_img_name = "0" + str(number) + "_poisson.jpg"
        else:
        ...
        if number < 10:
            rayleigh_img_name = "0" + str(number) + "_rayleigh.jpg"
        else:
        ...
        if number < 10:
            uniform_img_name = "0" + str(number) + "_uniform.jpg"
        else:
